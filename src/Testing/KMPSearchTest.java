...
public class KMPSearchTest {
    ...
    public void simple1() {
        ...
        System.out.print("KMP\n" + "Average Execution Time: " + timesTaken.stream().mapToLong(Long::longValue).sum() / 100 + " Average Operations Taken: " + operationsTaken.stream().mapToInt(Integer::intValue).sum() / 100 + "\n");
    }
    ...
    public void simpleBrute1() {
        ...
        System.out.print("Average Execution Time: " + timesTaken.stream().mapToLong(Long::longValue).sum() / 100 + " Average Operations Taken: " + operationsTaken.stream().mapToInt(Integer::intValue).sum() / 100 + "\n");
    }
